...
implements BoardPanel.BoardPanelListener  {
	...
	//"phootball.PhootballNullPlayer",
        "odd.OddRandomPlayer", "odd.MonteCarloPlayer"
    };
    private static final int BOARD_SIZE_X = odd.OddBoardPanel.SRAD * 3 *odd.OddBoardPanel.SCALE *
    											((odd.OddBoard.SIZE * 2 +1)+2);
    private static final int BOARD_SIZE_Y = odd.OddBoardPanel.CRAD * 2 * odd.OddBoardPanel.SCALE *
												((odd.OddBoard.SIZE * 2 +1)+2);
	...
	// very interresting here...
        ...
        boardPanel.setPreferredSize( new Dimension(BOARD_SIZE_X,BOARD_SIZE_Y));
        ...
        movePane.setPreferredSize(new Dimension(LIST_WIDTH,BOARD_SIZE_Y));
	...
	pack(); repaint();
        ...
        for( int i = 0; i < players.length; i++ )
            title.append( players[i] + " (Player" + (i+1) + ") " + (i < players.length-1 ? " vs. " : "" ) );
    ...
    implements BoardPanel.BoardPanelListener {
        public HumanPlayer() { super( "Human" ); }
